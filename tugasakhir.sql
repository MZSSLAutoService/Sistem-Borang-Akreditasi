...
-- Dumping data for table tugasakhir.led_cover: ~0 rows (approximately)
...
INSERT INTO `led_cover` (`id`, `id_prodi`, `prodi`, `pt`, `kota`, `th`, `upps`, `jenis_ps`, `alamat`, `telp`, `email_web`, `sk_pt`, `tgl_sk_pt`, `pp_sk_pt`, `sk_ps`, `tgl_sk_ps`, `pp_sk_ps`, `th_awal`, `peringkat_banpt`, `sk_banpt`, `nama_pys1`, `nidn_pys1`, `jabatan_pys1`, `tgl1`, `file_ttd1`, `nama_pys2`, `nidn_pys2`, `jabatan_pys2`, `tgl2`, `file_ttd2`, `nama_pys3`, `nidn_pys3`, `jabatan_pys3`, `tgl3`, `file_ttd3`, `nama_pys4`, `nidn_pys4`, `jabatan_pys4`, `tgl4`, `file_ttd4`, `kata_pengantar`, `ringkasan`, `created_at`, `updated_at`) VALUES
	(9, '006', '006', 'Quidem exercitation', 'Consequatur ex repu', 2019, 'Voluptatem blanditii', 'Deserunt ut corrupti', 'Amet dolore dolor q', '1234', 'Voluptatibus nihil u', '1234', '2016-04-25', 'Commodi voluptatem', '1234', '2017-07-03', 'Rerum vitae qui assu', 2005, 'A', '1234', 'Dignissimos quia rec', 1234, 'Ullam autem ut venia', '2016-02-03', 'Natus sint minima l', 'Consequuntur porro p', 1234, 'Cillum quia consequa', '1993-08-05', 'Quae reprehenderit', 'Delectus libero dol', 1234, 'Aliquam doloribus no', '1999-01-11', 'Vel quibusdam qui qu', 'Mollitia ullam solut', 1234, 'Amet suscipit offic', '1991-11-08', 'Tenetur mollit animi', '<p>1234</p>', '<p>1234</p>', '2019-06-18 23:18:43', '2019-06-18 23:18:43');
...
-- Dumping data for table tugasakhir.led_cover_prodi_upps: ~3 rows (approximately)
...
INSERT INTO `led_cover_prodi_upps` (`id`, `id_cover`, `jp_upps`, `prodi_upps`, `status`, `no_tgl_sk`, `tgl_kdw`, `jml_mhs`, `created_at`, `updated_at`) VALUES
	(11, '9', 'Non recusandae Quod', 'Minim quo temporibus', 'Duis omnis qui sed n', 'Magna ex optio amet', '1976-03-28', 12, '2019-06-19 06:18:43', '1970-01-01 00:00:00'),
	(12, '9', 'Quisquam ratione Nam', 'Cupidatat dolor comm', 'Ea in et cum illo na', 'Libero autem quia ut', '2017-11-06', 13, '2019-06-19 06:18:43', '1970-01-01 00:00:00'),
	(13, '9', 'Ex saepe ea sunt mol', 'Nobis at aut modi no', 'Odio sint eligendi a', 'Quia qui molestias p', '2006-11-25', 14, '2019-06-19 06:18:43', '1970-01-01 00:00:00');
