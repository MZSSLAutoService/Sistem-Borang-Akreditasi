                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    @if(Session::get('id_role')=="4")
                        <div class="body">
                            <?php
                                // dd($_GET['id']);
                                $cek=DB::table('led_c5')->where('id_prodi',$_GET['id'])->first();
                                // dd($cek);
                            ?>
                            <!-- UPDATE -->
                            ...
                            {{ csrf_field() }}
                                ...
                                <fieldset>
                                    <div class="row justify-content-end">
                                        ...
                                        <br>
                                        <div>
                                            <textarea rows="10" cols="800" name="pm_keupras" class="ckeditor" id="ckedtor">
                                                <?php echo $cek->pm_keupras?>
                                            </textarea>
                                        </div>
                                    </div>
                                </fieldset>
                        ...
                        <?php
                            $cek1=DB::table('komentar')->where('id_c5',$_GET['upps'])->first();
                        ?>
                        @if($cek1 != null)
                        ...
                        @else
                            ...
                            <h3>Simpulan Hasil Evaluasi dan Tindak lanjut</h3> 
                                <fieldset>
                                    ...
                                    <div class="modal-footer">
                                        <input type="hidden" name="id_c5" value="{{$id_c5}}"/>
                    ...
                    @else
                        <div class="body">
                            ...
                            ?>
                            <!-- UPDATE -->
                            <form action="{{ url('updatec5') }}" id="wizard_with_validation" method="POST">
                            {{ csrf_field() }}
                                <h3>Latar Belakang</h3>    
                                <fieldset>
                                    <div class="row justify-content-end">
                                            ...
                                            <div id="modalDelete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('c5.destroy', $cek->id) }}" method="POST">
                                                            {{ csrf_field() }}
                                                            @method('DELETE')
