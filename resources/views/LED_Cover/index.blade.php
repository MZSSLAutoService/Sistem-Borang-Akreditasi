                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        @if(Session::get('id_role')=="4")
                            <?php
                                $cek=DB::table('led_cover')->where('id_prodi',$_GET['id'])->first();
                            ?>
                            @if($cek !=null)
                                <div class="body">
                                    <?php
                            ...
                            @else
                                <div class="body">
                                    <h3>Halaman Muka/Cover</h3>
                                        <h2>Mohon Maaf Page sedang Pengisian</h2>
                                </div>
                            @endif
                        @else
                            <div class="body">
                                <?php
                                    ...
                                    // dd($cek1);
                                ?>
                                <form  action="{{ url('updatecover') }}" id="wizard_with_validation" method="POST">
                                    {{ csrf_field() }}
                                    <h3>Halaman Muka/Cover</h3>
                                    <fieldset>
                                        <center><img src="{{URL::asset('/images/logopolines.jpg')}}" enctype="multipart/form-data" alt="logopolines" width="20%" height="auto"  /></center><br>
                                            ...
                                            <div id="modalDelete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('cover.destroy', $cek->id) }}" method="POST">
                                                            {{ csrf_field() }}
                                                            @method('DELETE')
