                            ...
                            <div class="modal fade" id="modalAdd" tabindex="-1" role="dialog">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ url('prodiPost') }}" method="post">
                                        {{ csrf_field() }}
                                            <div class="form-group{{ $errors->has('id_role') ? ' has-error' : '' }}">
                                                <select name="jurusan" class="form-control show-tick">
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        <?php 
                                            $no=0;
                                        ?>
                                        @foreach($master_prodi as $master_prodi)
                                        <?php 
                                            $no++;
                                        ?>
                                        <tr>    
                                            <td><?php echo $no;?></td>
                                            <td>{{$master_prodi->nama}}</td>
                                            <td>
                                            <a href="#" class="btn btn-xs btn-success waves-effect" data-target="#modalEdit{{$master_prodi->id}}" data-toggle="modal"><i class="glyphicon glyphicon-pencil"></i></a>
                                                <!-- Modal -->
                                                <div class="modal fade" id="modalEdit{{$master_prodi->id}}" tabindex="-1" role="dialog">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                            ...
                                                            <div class="modal-body">
                                                            <form action="{{ route('prodi.update', $master_prodi->id) }}" method="POST">
                                                            {{ csrf_field() }}
                                                            @method('PUT')
                                                                <div class="form-group form-float form-group-lg ">                                                                  
                                                                    <div class="form-line">
                                                                    <input name="nama" type="text" class="form-control" value="{{$master_prodi->nama}}" />
                                            ...
                                            <a href="#" class="btn btn-xs btn-danger waves-effect" data-target="#modalHapus{{$master_prodi->id}}" data-toggle="modal"><i class="glyphicon glyphicon-remove"></i></a>
                                                <!-- Modal -->
                                                <div class="modal fade" id="modalHapus{{$master_prodi->id}}" tabindex="-1" role="dialog">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                            ...
                                                            <div class="modal-body">
                                                            <form action="{{ route('prodi.destroy', $master_prodi->id) }}" method="POST">
                                                            {{ csrf_field() }}
                                                            @method('DELETE')
