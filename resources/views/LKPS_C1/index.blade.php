                                    ...
                                    <div class="row justify-content-end">
                                        ...
                                        <div class="body table-responsive">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody id="C1_LKPS">
                                                <?php $i=1; ?>
                                                @foreach($lkps_c1 as $cek1)
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        <td><input value="<?php echo $cek1->lm?>" name="lembaga_mitra[0]" class="form-control form-control-sm" /></td>
                                                        <td><input value="<?php echo $cek1->t_inter?>" name="inter[1]" class="form-control form-control-sm" /></td>
                                                        <td><input value="<?php echo $cek1->t_nasional?>" name="nasional[2]" class="form-control form-control-sm" /></td>
                                                        <td><input value="<?php echo $cek1->t_lokal?>" name="lokal[3]" class="form-control form-control-sm" /></td>
                                                        <td><input value="<?php echo $cek1->judul?>" name="judul[4]" class="form-control form-control-sm" /></td>
                                                        <td><input value="<?php echo $cek1->manfaat?>" name="manfaat[5]" class="form-control form-control-sm" /></td>
                                                        <td><input value="<?php echo $cek1->waktu?>" name="waktu[5]" class="form-control form-control-sm" /></td>
                                                        <td><input value="<?php echo $cek1->bukti?>" name="bukti[5]" class="form-control form-control-sm" /></td>
                                                    </tr>
                                                <?php $i++;?>
                                                @endforeach
                                                ...
                                                <tfoot>
                                                    <tr >
                                                        <td>&Sigma;</td>
                                                        <td><input disabled name="1" class="form-control form-control-sm" /></td>
                                                        <td><input disabled name="2" class="form-control form-control-sm" /></td>
                                                        <td><input disabled name="3" class="form-control form-control-sm" /></td>
                                                        <td><input disabled name="4" class="form-control form-control-sm" /></td>
                                                        <td><input disabled name="5" class="form-control form-control-sm" /></td>
                                                        <td><input disabled name="6" class="form-control form-control-sm" /></td>
                                                        <td><input disabled name="7" class="form-control form-control-sm" /></td>
                                                        <td><input disabled name="8" class="form-control form-control-sm" /></td>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                        </div>
